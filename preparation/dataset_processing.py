    ...
    for i, offsets in enumerate(offset_mapping):
        ...
        if len(answers["answer_start"]) == 0:
            ...
            if not (offsets[token_start_index][0] <= start_char and offsets[token_end_index][1] >= end_char):
                ...
                # However, move the token_start_index and token_end_index to the two ends of the answer.
...
def prepare_validation_features(examples, tokenizer, max_seq_len, doc_stride):
